...
<img src="面试题库_files/1.png" alt="前端面试常考知识点"  />  
...
![BOM-location](Javascript/基础/images/BOM-location.png)  
...
![image-20210425162855623](面试题库_files/image-20210425162855623.png)
...
#### 14. 元素尺寸  
**DOM 中的 API**  
![picture](JavaScript/基础/images/offsetWidth.png)  
![picture](JavaScript/基础/images/clientWidth.png)  
![picture](JavaScript/基础/images/scrollWidth.png)  
...
```
![](面试题库_files/7.jpg) 变为 ![](面试题库_files/8.jpg) 方法如下：  
...
```
![](面试题库_files/9.jpg) 变为 ![](面试题库_files/10.jpg) 方法如下：  
...
```
![](面试题库_files/11.jpg) 变为 ![](面试题库_files/12.jpg) 方法如下：  
在 p 外面包裹一层容器  
```html
<body>
    <p>Haha</p>
...
```
![](面试题库_files/13.jpg) 变为 ![](面试题库_files/14.jpg) 方法如下：  
- 将容器设置为 flexbox (首选)  
```css
.box {
  display: flex;
...
![image-20210425154703601](面试题库_files/image-20210425154703601.png)
...
#### 8. `visibility: hidden`, `opacity: 0`, `display: none` 区别  
共同点：都把元素隐藏起来了  
...
#### 13. `display: table` 和 `<table></table>` 区别
