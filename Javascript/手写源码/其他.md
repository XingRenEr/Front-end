...
| --- |
| [二 自定义事件](#two) |
| &emsp;[2.1 创建自定义事件](#two-one) |
| &emsp;[2.2 事件的监听](#two-two) |
| &emsp;[2.3 事件的触发](#two-three) |
| &emsp;[2.4 案例](#two-four) |
| [三 Object.create()](#three) |
| [四 ES5 实现类继承](#four) |
| [五 instanceof](#five) |
| [六 柯里化](#six) |
| [七 迭代器](#seven) |
| [八 Ajax](#eight) |
| [九 数组扁平化](#night) |
| &emsp;[9.1 方法一：手撕递归](#night-one) |
| &emsp;[9.2 方法二：flat()](#night-two) |
| &emsp;[9.3 方法三：reduce](#night-three) |
| [十 对象扁平化](#ten) |
| [十一 数组去重](#eleven) |
| &emsp;[11.1 方法一：手撕去重](#eleven-one) |
| &emsp;[11.2 方法二：Set](#eleven-two) |
| &emsp;[11.3 方法三：filter](#eleven-three) |
| [十二 其他](#twelve) |
| [十三 参考文献](#thirteen) |
<!-- 目录结束 -->
...
## <a id="night"></a>九 数组扁平化

> [返回目录](#one)

### <a id="night-one"></a>9.1 方法一：手撕递归
...
### <a id="night-three"></a>9.3 方法三：reduce
...
## <a id="eleven"></a>十一 数组去重

> [返回目录](#one)

看着本文标题是 3 种，实际上有 5 种。

### <a id="eleven-one"></a>11.1 方法一：手撕去重
...
### <a id="eleven-two"></a>11.2 方法二：Set
...
### <a id="eleven-three"></a>11.3 方法三：filter
